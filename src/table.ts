...
export const TableCell = b.createVirtualComponent({
    render(ctx: ITableCtx, me: b.IBobrilNode) {
        me.children = { tag: ctx.data.hyperlink ? "td" : "td", attrs: { colSpan: ctx.data.colSpan }, children: ctx.data.children }; //TODO: change first tag to hyperlink tag
...
const tableStyle = b.styleDef( [tableStyleBase, {
    //textAlign: "right" -- tableFooter
    width: "100%"
}]);

const tableStylePagination = b.styleDef( [tableStyleBase, {
    textAlign: "right"
}]);
